...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec 18 15:52:37 2018
"""
...
import model
import pickle
from json_data_retrieval import json_grabber
...
sample_sentence = ( [sent] * int(sample_size) )  #feeding the input here
#sample_sentence = ( ["a red flower with a yellow centre"] * int(sample_size) )
